            ...
            <header className="head">
                <div className="head0">
                    <div className="imagelogo">
                        <img src={logo} className="imagelogo1" alt="unable to display" />
                    </div>
                    <div className="loc">
                        <div className="loc0">
                            <div className="set0">
                                <span className="set"> Set location
                                   
                                </span>
                            </div>
                            <div className="choose0">
                                <span className="choose"> Click to Choose Location </span>
                            </div>
                    ...
                    <div className="hdlist">
                        <div className="hdlist0">
                            <div className="help orange"><a><svg className="_1GTCc" viewBox="6 -1 12 25" height="19" width="19">
                                <path
                            ...
                            <div className="sign orange"><Link to="/Login" className='LinkClass'>
                                <svg className="_1GTCc2" viewBox="6 0 12 24" height="19" width="18">
                                    <path
                            ...
                            <div className="cart orange"><a>
                                <svg className="_1GTCc3" viewBox="-1 0 37 32" height="20" width="20">
